...
- **[Event Analytics Platform](https://github.com/meelod/event-analytics)** — Mixpanel-style analytics with natural-language → SQL via GPT-4o. FastAPI + React + DuckDB.
- **[PartSelect RAG Chatbot](https://github.com/meelod/rag-chatbot)** — Product assistant with semantic search over scraped docs. React + Node + ChromaDB.
- **[Analogous Document Discovery](https://github.com/meelod/web-crawler)** — Crawler that finds all versions of a recurring document from a seed URL. FastAPI + Gemini + SSE streaming.
